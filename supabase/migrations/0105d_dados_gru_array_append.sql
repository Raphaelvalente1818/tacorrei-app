-- 0105d — dados_gru: "malformed array literal" ao montar a lista do que falta.
-- `text[] || 'Chassi'` com literal sem tipo e resolvido como array || array e o
-- Postgres tenta ler 'Chassi' como array. array_append e inequivoco.
-- Aplicada em 23/09/2026 (achado no primeiro teste do preview).
